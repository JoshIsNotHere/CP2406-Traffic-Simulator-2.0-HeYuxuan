...
public class Road {
    //Set the coordinates of the path
    ...
    public ArrayList<Point> choose(int begin, int end) {
        //BSN-EHW
        //For the turning road, record the starting point, turning point, end point
        if (begin == 1 && end == 2) {
            RoadList.add(A); // A
            RoadList.add(R1); // R1
            RoadList.add(D); // D
        ...
        //BSN-BSS
        //For straight-moving vehicles, record the starting point, exit at the traffic light, and the end point
        ...
        //EHW-BSN
        //For U-turn cars, record the coordinates of the turning point
